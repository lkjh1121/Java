...
public class Sub2_StringTest {
	...
	public static void main(String[] args) {
		...
		if(str1 == str2) {
			System.out.println("str1 참조값과 str2 참조 값는 같다.");
		}else {
			System.out.println("str1과 참조값과 str2 참조값는 다르다.");
		}
		...
		System.out.println("문자열 hello 7~마지막까 자르기 : "+hello.substring(6));
		...
		// 문자열 교체
		System.out.println("무자열 'Korea' 를 'Busan'으로 교체 : "+hello.replace("Korea", "Busan"));
